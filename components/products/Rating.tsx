...
export const Rating = ({
  ...
  return (
    <div
      className={cn(`flex items-center gap-2 ${isCard && 'flex-col items-start gap-1'} ${!isCard && 'items-center'}`)}
    >
      ...
      {caption && !numReviews && <div className='text-xs text-gray-500'>{caption}</div>}
    </div>
  );
};
